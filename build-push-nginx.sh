...
docker tag $tag 165485842251.dkr.ecr.ap-south-1.amazonaws.com/care-dev-nginx:$tag
docker push 165485842251.dkr.ecr.ap-south-1.amazonaws.com/care-dev-nginx:$tag
